...
class Config extends Singleton
{
	...
	/**
	 * Sets the filename extension where models are located (start with a dot, and contains only alphanumeric characters and dot)
	 *
	 * @param string $ext Extention of your models files
	 * @return void
	 * @throws ConfigException if specified extension was invalid
	 */
